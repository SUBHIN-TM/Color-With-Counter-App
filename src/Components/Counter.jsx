  ...
  return (
    <>
      <div className='outLine m-auto'>
        <div className={`innerLine colorChange ${colorSelect[count]} `}>
        {/* <div className={`innerLine colorChange ${getColorClass()} `}> */}
          ...
          <button onClick={() => resetFunction()} className='border p-1 bg-black text-white font-semibold mt-2 ml-5 px-3'>Reset</button>
          <div className='border mt-4 p-10 bg-black'>
            <div className={`border colorChange ${colorSelect[count]}`}>
